...
public class WeatherContract {
    ...
    // The relationship between Content authority and content provier is similar to domain name and its website.
    public static final String CONTENT_AUTHORITY = "com.android.jahunkoo.sunshineexercise";
